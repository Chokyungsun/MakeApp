...
//        }
        ...
        foundation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                url_[0] += "?product_type=foundation";
